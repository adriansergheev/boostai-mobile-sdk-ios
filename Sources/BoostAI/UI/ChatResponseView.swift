...
open class ChatResponseView: UIView {
    ...
    open func actionLinkView(text: String, type: LinkType, isUploadButton: Bool = false) -> UIView? {
        ...
        let iconImage = UIImage(named: iconName, in: Bundle.module, compatibleWith: nil)
    ...
    open func setupView() {
        ...
        let thumbsUpIcon = UIImage(named: "thumbs-up", in: Bundle.module, compatibleWith: nil)
        ...
        let thumbsDownIcon = UIImage(named: "thumbs-down", in: Bundle.module, compatibleWith: nil)
    ...
    private func setFeedbackValue(_ feedbackValue: FeedbackValue, sender: UIButton) {
        ...
        if let currentValue = self.feedbackValue, currentValue == feedbackValue {
            ...
            case .positive:
                sender.setImage(UIImage(named: "thumbs-up", in: Bundle.module, compatibleWith: nil), for: .normal)
                sender.tintColor = messageFeedbackOutlineColor
                backend.feedback(id: id, value: .removePositive)
            case .negative:
                sender.setImage(UIImage(named: "thumbs-down", in: Bundle.module, compatibleWith: nil), for: .normal)
                sender.tintColor = messageFeedbackOutlineColor
        ...
        switch feedbackValue {
        case .positive:
            thumbsUpButton.setImage(UIImage(named: "thumbs-up-filled", in: Bundle.module, compatibleWith: nil), for: .normal)
            thumbsUpButton.tintColor = messageFeedbackSelectedColor
            thumbsDownButton.setImage(UIImage(named: "thumbs-down", in: Bundle.module, compatibleWith: nil), for: .normal)
            thumbsDownButton.tintColor = messageFeedbackOutlineColor
        ...
        case .negative:
            thumbsUpButton.setImage(UIImage(named: "thumbs-up", in: Bundle.module, compatibleWith: nil), for: .normal)
            thumbsUpButton.tintColor = messageFeedbackOutlineColor
            thumbsDownButton.setImage(UIImage(named: "thumbs-down-filled", in: Bundle.module, compatibleWith: nil), for: .normal)
