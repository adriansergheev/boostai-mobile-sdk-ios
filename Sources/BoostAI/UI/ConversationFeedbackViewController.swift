...
open class ConversationFeedbackViewController: UIViewController {
    ...
    public func setupView() {
        ...
        submitButton.setImage(UIImage(named: "submit-text-icon", in: Bundle.module, compatibleWith: nil), for: .normal)
    ...
    private func setFeedbackValue(_ feedbackValue: FeedbackValue, sender: UIButton) {
        ...
        sender.setImage(UIImage(named: filledName, in: Bundle.module, compatibleWith: nil), for: .normal)
        ...
        if let stackView = sender.superview as? UIStackView {
            for view in stackView.arrangedSubviews {
                if view.isKind(of: UIButton.self) && view != sender, let button = view as? UIButton {
                    button.setImage(UIImage(named: otherName, in: Bundle.module, compatibleWith: nil), for: .normal)
                }
            }
        }
