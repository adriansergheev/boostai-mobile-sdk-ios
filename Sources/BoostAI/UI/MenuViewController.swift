...
open class MenuViewController: UIViewController {
    ...
    open func setupView() {
        ...
        if backend.privacyPolicyUrl.count > 0 {
            ...
            button.setImage(UIImage(named: "external-link-icon", in: Bundle.module, compatibleWith: nil), for: .normal)
        ...
        let poweredByBoostImageView = UIImageView(image: UIImage(named: "boost-ai-logo-outline", in: Bundle.module, compatibleWith: nil))
